    ...
    return (
        <>
            <div className="projects-div">
                <img className="project-gif" src={projectBank.triage.gif} alt="gif of project UX/UI" />
            </div>
            ...
            <p className="project-title"> {projectBank.triage.title} </p>

            <p className="project-description"> {projectBank.triage.description} </p>
